            ...
            {loading ? (
                ...
                (
                    <div className={"col-12"}>
                        <form className={"container mt-5 text-center"} onSubmit={formik.handleSubmit} action={""}>
                            ...
                            {formik.touched.password && formik.errors.password ? (
                                <small
                                    className={"text-danger text-sm-center"}>{formik.errors.password}</small>) : null}
                            <br/>
                            {/*<p onClick={() => setShow(!show)}*/}
                            {/*   className={"text-primary text-decoration-underline"}>{!show ? "show password" : "hide password"}</p>*/}
                            <Link to={"/forget-password"}>
                                <small className={"align-content-end text-decoration-underline"}>forgot
                                    password?</small>
                            </Link>
                            <br/>
